...
description: Work safely in vendored or nested runtime trees by separating upstream code, local deployment config, generated artifacts, ignored secrets, and project-specific customizations.
---

# Vendored Runtime Maintainer

Use this when inspecting or changing nested runtime code or upstream-derived deployment trees.
