...
# Using OpenAI provider type pointing to our bridge for wan2.7-image
config_payload = {
    "image_provider_id": "wan-dashscope",
...
print("Configuring Wan Image Generation via Bridge...")
...
if resp.status_code in [200, 201]:
    ...
    print("Provider ID already exists. Trying to update it if there's a PUT endpoint, or setting it as default...")
else:
