    ...
    <div className="flex h-full flex-col">
      <PageHeader>
        <div className="flex flex-col">
          <h1 className="text-lg font-semibold tracking-tight">Computer Agent</h1>
          <p className="text-xs text-muted-foreground">Coasty.ai / open-computer-use Concept</p>
        </div>
      </PageHeader>
      <div className="flex-1 overflow-hidden p-6 bg-muted/20">
        <div className="h-full w-full overflow-hidden rounded-xl border border-border bg-background shadow-sm">
          <iframe 
            ...
            title="Computer Agent (coasty.ai)"
          />
        </div>
      </div>
    </div>
