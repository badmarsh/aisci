...
const workspaceNav: { key: NavKey; labelKey: NavLabelKey; icon: typeof Inbox }[] = [
  ...
  { key: "hepPhysics", labelKey: "hep_physics", icon: Activity },
  { key: "openComputerUse", labelKey: "open_computer_use", icon: Monitor },
  { key: "workflows", labelKey: "workflows", icon: Network },
];
