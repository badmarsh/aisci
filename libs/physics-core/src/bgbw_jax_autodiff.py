...
def bgbw_likelihood(params, pt_data, yield_data, error_data, mass_gev):
    ...
    # Integrand logic matching libs/physics-core/src/fitting_pipeline.py but scaled
...
def main():
    ...
    parser.add_argument("--data", type=str, default="libs/physics-core/data/fit_input.csv")
