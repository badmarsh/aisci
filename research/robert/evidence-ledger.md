...
| Claim | Evidence Required | Current Evidence | Status | Next Gate |
|-------|-------------------|------------------|--------|-----------|
| **Laccase-Catalyzed Biotransformation of Dihydrostilbenes and Phenanthrenes: A Route to Novel Natural Product Derivatives**<br>Extracted claim from Laccase-Catalyzed Biotransformation of Dihydrostilbenes and Phenanthrenes: A Route to Novel Natural Product Derivatives | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.1021/acsomega.6c01880 | Opens new line | Fallback categorization due to LLM unavailability. |
| **Multiplicity dependence of two-particle angular correlations of identified particles in pp collisions at $$\mathbf {\sqrt{s} = 13}$$ TeV**<br>Extracted claim from Multiplicity dependence of two-particle angular correlations of identified particles in pp collisions at $$\mathbf {\sqrt{s} = 13}$$ TeV | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.1140/epjc/s10052-026-15447-z | Opens new line | Fallback categorization due to LLM unavailability. |
| **MC@NLO event generation by reweighting unweighted born events**<br>Extracted claim from MC@NLO event generation by reweighting unweighted born events | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.1140/epjc/s10052-026-16034-y | Opens new line | Fallback categorization due to LLM unavailability. |
| **Characterizing observed aerosols and their impacts on shallow cumulus clouds during the TRACER field campaign**<br>Extracted claim from Characterizing observed aerosols and their impacts on shallow cumulus clouds during the TRACER field campaign | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.5194/egusphere-2026-3116 | Opens new line | Fallback categorization due to LLM unavailability. |
| **Quantum interference effects enhanced in $π^+p$ femtoscopic correlation functions**<br>Extracted claim from Quantum interference effects enhanced in $π^+p$ femtoscopic correlation functions | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.48550/arxiv.2607.04351 | Opens new line | Fallback categorization due to LLM unavailability. |
| **Coupled charm and charmonium transport in a strongly coupled quark–gluon plasma**<br>Extracted claim from Coupled charm and charmonium transport in a strongly coupled quark–gluon plasma | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.1140/epja/s10050-026-01897-2 | Opens new line | Fallback categorization due to LLM unavailability. |
| **Simple-idealized-1d-nlse: Pseudo-spectral solver for the 1D nonlinear Schrödinger equation**<br>Extracted claim from Simple-idealized-1d-nlse: Pseudo-spectral solver for the 1D nonlinear Schrödinger equation | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.31349/revmexfise.23.020206 | Opens new line | Fallback categorization due to LLM unavailability. |
| **Probing Rotational Dynamics of Quark Gluon Plasma via Global Vorticity**<br>Extracted claim from Probing Rotational Dynamics of Quark Gluon Plasma via Global Vorticity | Methods: Automated Extraction Fallback<br>Datasets: Unknown Dataset | Limitations: Abstract-only extraction due to API failure<br>DOI: 10.1016/j.physletb.2026.140714 | Opens new line | Fallback categorization due to LLM unavailability. |
